        ...
        <div id="page-content-wrapper" class="administrador">
            <div class="container">
                <p class="first">Carrito de Compras</p>
                        ...
                        <p class="titulo-admin ml-0">Tu Carrito de Compras esta vacío.</p>

                        <ul class="checkout-types bottom">
                            <li><a class="btn btn-dark seguir-comprando" href="{{url('/productos')}}">Agregar productos</a>
                            </li>
                            @else
