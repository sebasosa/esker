    ...
    public function run()
    {
      ...
      foreach ($products1 as $prod) {
        DB::table('images')->insert([
          ...
          'ext'=> 'jpg',
          'product_id' => $prod->id,
          'url'=> 'WATERDOG DOME 3 2.jpg' ,
          'created_at' => date("Y-m-d H:i:s"),
          'updated_at' => date("Y-m-d H:i:s")],
          ['name'=> 'WATERDOG DOME 3 3',
          'ext'=> 'jpg',
          'product_id' => $prod->id,
          'url'=> 'WATERDOG DOME 3 3.jpg' ,
          'created_at' => date("Y-m-d H:i:s"),
          'updated_at' => date("Y-m-d H:i:s")]
        ]);
      }
      ...
      foreach ($products1 as $prod) {
        DB::table('images')->insert([
          ...
          'ext'=> 'jpg',
          'product_id' => $prod->id,
          'url'=>'Natway Blac 30 2.jpg' ,
          'created_at' => date("Y-m-d H:i:s"),
          'updated_at' => date("Y-m-d H:i:s")],
          ['name'=> 'Natway Blac 30 3',
          'ext'=> 'jpg',
          'product_id' => $prod->id,
          'url'=> 'Natway Blac 30 3.jpg',
          'created_at' => date("Y-m-d H:i:s"),
          'updated_at' => date("Y-m-d H:i:s")]
        ]);
      }
      ...
      foreach ($products1 as $prod) {
        DB::table('images')->insert([
          ...
          'ext'=> 'jpg',
          'product_id' => $prod->id,
          'url'=> 'Botas Borcegos Hi Tec 2.jpg',
          'created_at' => date("Y-m-d H:i:s"),
          'updated_at' => date("Y-m-d H:i:s")],
          ['name'=> 'Botas Borcegos Hi Tec 3',
          'ext'=> 'jpg',
          'product_id' => $prod->id,
          'url'=> 'Botas Borcegos Hi Tec 3.jpg' ,
          'created_at' => date("Y-m-d H:i:s"),
          'updated_at' => date("Y-m-d H:i:s")]
        ]);
      }
      ...
      foreach ($products1 as $prod) {
        DB::table('images')->insert([
          ...
          'ext'=> 'jpg',
          'product_id' => $prod->id,
          'url'=> 'WATERDOG TA450D 2.jpg',
          'created_at' => date("Y-m-d H:i:s"),
          'updated_at' => date("Y-m-d H:i:s")],
          ['name'=> 'WATERDOG TA450D 3',
          'ext'=> 'jpg',
          'product_id' => $prod->id,
          'url'=> 'WATERDOG TA450D 3.jpg',
          'created_at' => date("Y-m-d H:i:s"),
          'updated_at' => date("Y-m-d H:i:s")]
        ]);
      }
      ...
      foreach ($products1 as $prod) {
        DB::table('images')->insert([
          ...
          'ext'=> 'jpg',
          'product_id' => $prod->id,
          'url'=> 'Hi-Tec Tortola Escape 2.jpg',
          'created_at' => date("Y-m-d H:i:s"),
          'updated_at' => date("Y-m-d H:i:s")],
          ['name'=> 'Hi-Tec Tortola Escape 3',
          'ext'=> 'jpg',
          'product_id' => $prod->id,
          'url'=> 'Hi-Tec Tortola Escape 3.jpg' ,
          'created_at' => date("Y-m-d H:i:s"),
          'updated_at' => date("Y-m-d H:i:s")]
        ]);
      }
